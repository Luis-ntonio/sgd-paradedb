...
print(f"{random_pdf_files(s3_bucket, 'inaigem-sgd-data', 200)} files were uploaded to sgd-rag-test/Documentos/")
#print(f"{download_files_from_s3(s3_bucket, 'inaigem-sgd-data', 10)}") 
